...
import com.bb.item.entity.TenantLotteryCat;
...
public class HttpUtils {
    ...
    @Autowired
    private TenantLotteryCatMapper catMapper;
    @Autowired
     ...
     */
    public static ResponeVo get(String url) throws IOException, InterruptedException {
    ...
    //   HttpHost host = new HttpHost("107.148.222.10",8443);
        //加入全局请求令牌权限
    ...
    //双色球get请求  需要单独添加agent
    public static ResponeVo get(String url,String agent) throws IOException, InterruptedException {
